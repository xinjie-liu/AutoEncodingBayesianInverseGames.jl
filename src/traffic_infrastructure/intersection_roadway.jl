...
function build_roadway(opts::FourIntersectionRoadwayOptions{T}) where {T}
	...
	function f_north_left_straight(s,v=0.)
	end
	...
	# North lane with left turn and straight
	north_lane_left_straight = Lane(13,
	:north_lane_left_straight,
	[w301, w309, w310],
	[c312],
	StartingArea(
		VehicleState(-lw/4, ll/2, -1.57,  0.00),
	...
	lanes = [
		...
		south_lane_straight, south_lane_right, south_lane_left, north_lane_left_straight]
